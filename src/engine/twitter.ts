...
import { TWITTER_SYSTEM_PROMPT, buildTwitterPrompt } from "./prompts.ts";
...
export async function generateThread(
  ...
  logger.info("Generating Twitter thread", { date: digest.date, stories: digest.topStories.length });
